...
export default function Register() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-4 relative z-10 overflow-hidden">
      ...
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-emerald-500/5 rounded-full blur-[120px] pointer-events-none"></div>
      ...
      <div className="glass-card border-white/10 rounded-[2.5rem] p-8 md:p-12 w-full max-w-md relative z-10 shadow-2xl bg-[#0a0a0a]/80">
        ...
        <p className="text-center text-slate-400 text-sm mt-8 font-medium">
          ...
          <a href="/login" className="text-amber-500 hover:text-amber-400 font-bold underline transition-colors">Sign in</a>
        </p>
      </div>
    </main>
  )
